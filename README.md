...
**Hello rails backend** is a simple project for creating an API endpoint to handle backend for [hello react frontend](https://github.com/fuadmoin/hello-react-front-end) project.
...
- **You can add a greeting message using rails console.**
- **Has API end points.**
...
```sh
  cd All-in-one
  git https://github.com/fuadmoin/hello-rails-back-end.git
```
